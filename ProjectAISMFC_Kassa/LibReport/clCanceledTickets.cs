...
namespace LibReport
{
    class clCanceledTickets
    {
        ...
        public string Id_EmpMot { get; set; }        
        public DataGridView Data { get; set; }
        public string path = "";

        string EtalonCanceled = clDataFile.GetPathCanceledFile();

        public clCanceledTickets()
        {
            // Запускаем приложение
            ExcelAPP = new Excel.Application();
            // Открываем файл
            ExcelAPP.Workbooks.Open(EtalonCanceled);
